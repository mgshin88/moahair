		...
		Plugin.prototype = {
				...
				createDOM: function() {
					var $wrapper = $('<div class="' + this.options.wrapperClass + '"></div>'),
						...
						$indicator = this.options.useImage ? 
						   $('<img src="' + this.options.loadingImage + '" />') : 
						   $('<div class="loading-indicator-text"><div class="' + this.options.loadingClass + '"></div><div class="loading-indicator-msg">'+this.options.msg+'</div></div>');
