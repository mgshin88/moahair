...
$(document).ready(function() {
	...
	function pay(today, time) {
		...
		$("#disp7").html("<input type = 'submit' class='buttontd2' value='수정하기'>");
...
<body>
	...
	<form action = "/moahair/booking/modifyPro.do" method="post" id="disp3">
	<input type = 'hidden' name='bk_num' value='${bk_num}' >
	<input type = 'hidden' name='du' value='${dr}' >
	<div id="disp4"></div>
	<div id="disp5"></div>
	<div id="disp6"></div>
	<div id="disp7"></div>
