...
<div class="header">
	...
	<div class="navi_bar_admin">
		<ul>

			<li class="navi_menu_admin" id="seller_product" style="	margin-top:20px;
			">
			<span id="inputshopshow" class="myPageHover">비즈니스 등록</span> <br />

			</li>
			<li class="navi_menu_admin" id="seller_product" style="	margin-top:20px;
			">
			<span id="usershow" class="myPageHover">사용자관리</span>

			</li>
			<li class=navi_menu_admin id="seller_staff">
			<br /> <span id="sellershow" class="myPageHover" st>판매자관리</span>


			</li>
			<li class="navi_menu_admin" id="seller_sales">
			<br /> <span id="itemshow" class="myPageHover">상품관리</span>

			</li>
			<li class="navi_menu_admin" id="seller_info">
			<br /> <span id="totalshow" class="myPageHover">판매수익</span>

			</li>

			<li class="navi_menu_admin" style="	margin-top:20px;
			">
