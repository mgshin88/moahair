...
<body>
	...
	<div class="container">
		<div class="contentDetail">
			<span class="SellerItem SellerHover"> 스타일 </span>
			
			<span class="SellerDesigner SellerHover"> 디자이너 정보 </span>
		</div>
	...
	<div class="container">
		<div class="contentSellerItem">
			...
			<div class="containerItemwidth">
				<a href="/moahair/seller/product.do?i_num=${bsitemList.i_num }"> 
		...
		<div class="contentDesignerView">
			<c:forEach var="slist" items="${slist }">
				<div class="containerDesignerwidth">
					<a href="/moahair/seller/staff.do?s_num=${slist.s_num }"> <img src="/moahair/img/seller/staff/${slist.s_profile }"
						class="float" />
						<div>
