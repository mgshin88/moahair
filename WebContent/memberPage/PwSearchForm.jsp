...
<body>
	...
	<div class="logregHeader">
		<div class="logregTitle">비밀번호 찾기</div>
	</div>
	
	<div class="logregFormView">
		<form action="/moahair/member/PwSearchUpdateForm.do" id="formLogin" name="myform" class="searchPw simpleForm"
		 method="post" onSubmit="return checkItPwSearch()">
			<ul class="borderRight">
				<li>
					<input type="text" id="si_id" name="si_id" placeholder="아이디 입력" title="아이디 입력"/>					
				</li>
				...
				<li>
					...
					onclick="return checkPwCerfity()">
					<div id="emailResult"></div>
				</li>
				<li>
					<p>가입 후 입력하신 아이디, 이름, 이메일 주소를 정확하게 입력 하셔야 인증이 가능합니다.</p>
				</li>
				<li>
