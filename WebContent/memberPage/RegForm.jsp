...
<link rel="stylesheet" type="text/css" href="/moahair/css/kyuCSS.css?ver=2">
...
<body>
	...
	<div class="logregHeader">
		<div class="logregTitle">회원가입</div>
	</div>
		<div class="logregFormView">
		<form id="formReg" class="regForm simpleForm" action="/moahair/member/RegPro.do" method="post" name="userinput"
