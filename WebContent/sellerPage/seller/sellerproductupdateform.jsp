...
<form action="/moahair/seller/sellerproductupdatepro.do" name="itemwriteform" method="post" enctype="multipart/form-data">
	...
	<input type="submit" class="AddBtn" value="수정" onclick="submitContents(this)"    />
	<input type="button" class="AddBtn" value="목록" onclick="updateItemCel(${pageNum})"/>
