...
public class SellerTotalListAction implements SuperAction {
	...
	public String requestPro(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(m_level == 10) {
			...
			ArrayList seller_total = dao.seller_total(time1, time2);
			
			
			request.setAttribute("seller_total", seller_total);
		...
		return "/supervisor/sellertotalList.jsp";
	}
